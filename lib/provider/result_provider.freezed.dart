...
abstract class $ResultStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ResultModel> results});
}
...
class _$_ResultState implements _ResultState {
  _$_ResultState({final List<ResultModel> results = const []})
      : _results = results;
  ...
  @override
  String toString() {
    return 'ResultState(results: $results)';
  }
...
abstract class _ResultState implements ResultState {
  factory _ResultState({final List<ResultModel> results}) = _$_ResultState;
